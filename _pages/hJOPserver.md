...
technologické bloky, připojit se ke kolejišti pomocí [MTB]() a [LI]() a řídit jej.
Umožňuje připojení [obslužných pracovišť] skrze počítačovou síť a komunikaci
...
hJOPserver využívá [MTB knihovnu]().
